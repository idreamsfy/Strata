...
public class BlackSwaptionCashParYieldProductPricer {
   ...
   * <p>
   * The present value gamma is given by {@code discountFactor * annuityCash * blackGamma} where {@code blackGamma} is 
   * the second derivative of Black price with respect to forward. 
   * <p>
   * The result is expressed using the currency of the swapion.
   * 
   * @param swaption  the product to price
