...
import com.opengamma.strata.finance.rate.future.IborFutureConvention;
...
public class IborFutureCurveNodeTest {
  ...
  public void test_initialGuess() {
    ...
    double approximateMaturity = TEMPLATE.getPeriodToStart().plus(TEMPLATE.getConvention().getIndex().getTenor()).toTotalMonths() / 12.0d;
