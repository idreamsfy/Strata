...
/**
 * A market convention for Ibor-Ibor cross-currency swap trades.
 * <p>
...
public final class ImmutableXCcyIborIborSwapConvention
  ...
  public SwapTrade toTrade(
    ...
    SwapLeg leg1 = spreadLeg.toLeg(startDate, endDate, PayReceive.ofPay(buySell.isBuy()), notionalSpread, spread);
    SwapLeg leg2 = flatLeg.toLeg(startDate, endDate, PayReceive.ofPay(buySell.isSell()), notionalFlat);
