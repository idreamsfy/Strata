...
public final class TermDepositConventions {
  ...
  /**
   * The 'EUR-Deposit-T' term deposit convention with T settlement date, used mainly for O/N deposits.
   */
  public static final TermDepositConvention EUR_DEPOSIT_T =
      TermDepositConvention.of(StandardTermDepositConventions.EUR_DEPOSIT_T.getName());
  /**
  ...
  /**
   * The 'USD-Deposit-T' term deposit convention with T settlement date, used for O/N deposits.
   */
  public static final TermDepositConvention USD_DEPOSIT_T =
      TermDepositConvention.of(StandardTermDepositConventions.USD_DEPOSIT_T.getName());
  /**
