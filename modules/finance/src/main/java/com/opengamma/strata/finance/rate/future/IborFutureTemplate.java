...
public class IborFutureTemplate
   ...
   * @return the template
   */
  public static IborFutureTemplate of(Period periodToStart, int number, IborFutureConvention convention) {
    return IborFutureTemplate.builder().periodToStart(periodToStart).number(number).convention(convention).build();
  }
   ...
   * @param quantity  the number of contract traded
  ...
  public IborFutureTrade toTrade(LocalDate tradeDate, long quantity, double notional, double price) {
    return convention.toTrade(tradeDate, periodToStart, number, quantity, notional, price);
  }
  
  public LocalDate referenceDate(LocalDate tradeDate) {
    return convention.referenceDate(tradeDate, periodToStart, number);
  }
