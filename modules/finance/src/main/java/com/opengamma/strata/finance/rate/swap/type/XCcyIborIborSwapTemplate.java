 ...
 * The market quotes a spread on one leg.
 * <p>
...
public final class XCcyIborIborSwapTemplate
   ...
   * @return the trade
   */
  public SwapTrade toTrade(LocalDate tradeDate, 
      BuySell buySell, 
      double notionalSpread, 
      double notionalFlat, 
      double spread) {
    return convention.toTrade(tradeDate, periodToStart, tenor, buySell, notionalSpread, notionalFlat, spread);
  }
