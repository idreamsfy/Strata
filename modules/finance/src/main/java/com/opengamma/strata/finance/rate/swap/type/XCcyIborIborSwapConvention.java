 ...
 * <p>
 * For example, a 'EUR / USD' basis swap has 'EUR-EURIBOR-3M' as the spread leg and 'USD-LIBOR-3M'
 * as the flat leg.
 * <p>
...
public interface XCcyIborIborSwapConvention
   ...
   * @param notionalSpread  the notional amount for the spread leg
   * @param notionalFlat  the notional amount for the flat leg
  ...
  public default SwapTrade toTrade(
      ...
      Tenor tenor,
      BuySell buySell,
      double notionalSpread,
      double notionalFlat,
      double spread) {

    return toTrade(tradeDate, Period.ZERO, tenor, buySell, notionalSpread, notionalFlat, spread);
  }
  ...
  public default SwapTrade toTrade(
    ...
    return toTrade(tradeDate, startDate, endDate, buySell, notionalSpread, notionalFlat, spread);
  }
