...
final class StandardTermDepositConventions {
  ...
  // EUR with value date T; used for O/N
  public static final TermDepositConvention EUR_DEPOSIT_T = ImmutableTermDepositConvention.builder()
      .name("EUR-Deposit-T")
  ...
  // USD with value date T; used for O/N
  public static final TermDepositConvention USD_DEPOSIT_T = ImmutableTermDepositConvention.builder()
      .name("USD-Deposit-T")
